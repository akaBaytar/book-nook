...
const EndColumn = () => {
  ...
  return (
    <div className='bg-sidebar rounded-md border p-4 me-4 lg:me-0 flex flex-col gap-5 lg:w-[19rem] lg:fixed lg:right-4 lg:top-4 lg:h-[calc(100vh-2rem)] lg:overflow-y-auto'>
